...
function sendPaymentEmail(firstName, toEmail) {
  ...
  var body = [
    ...
    '',
    'To confirm your reservation, please complete your payment within 24 hours via PAY ID below.',
    '',
    'Amount: AUD 308',
    'PAY ID: 0404485393',
    '',
    'Please note that reservations will be automatically cancelled if payment is not received within 24 hours.',
    '',
