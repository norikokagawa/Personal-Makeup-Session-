  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How do I find my undertone?',
        a: ['<p>Undertone does not change with a tan, and it decides more than depth does. Look at the inside of your wrist in daylight:</p>',
            '<ul><li><strong>Warm</strong> — veins look green, gold jewellery suits you, you tan easily. Choose beige, golden and coral tones.</li><li><strong>Cool</strong> — veins look blue or purple, silver suits you, you burn before you tan. Choose rose, pink and plum tones.</li><li><strong>Neutral</strong> — you cannot tell, and both metals look fine. Almost everything works; start with the shade described as “most chosen”.</li></ul>'] },
      { q: 'How do I match a foundation shade?',
        a: ['<ol><li>Test along the jawline, never on the hand or the wrist.</li><li>Look at it in daylight, near a window, without other makeup on.</li><li>The right shade disappears. If you can see where it starts, it is wrong.</li><li>Between two shades, take the deeper one — skin darkens slightly through the year in Singapore.</li></ol>',
            '<p>Most atelierR clients settle on a light-to-medium neutral beige. If you are ordering blind, that is the safest starting point.</p>'] },
      { q: 'How do I choose a lipstick or blush shade?',
        a: ['<p><strong>Lipstick</strong></p>',
            '<ul><li>For everyday wear, choose one or two steps deeper than your natural lip colour.</li><li>Matte finishes read deeper than they look in the tube — choose one step lighter than you would in a glossy formula.</li><li>Sheer and glaze finishes are the most forgiving; they blend with your own lip tone rather than covering it.</li><li>If your eye makeup is strong, keep the lip quiet, and the other way round.</li></ul>',
            '<p><strong>Blush</strong></p>',
            '<ul><li>Warm coral and peach lift most skin tones in daylight.</li><li>Rose and mauve suit cool undertones and evening light.</li><li>A useful test: the colour your cheeks turn after a brisk walk is the colour that suits you.</li></ul>'] },
      { q: 'How do I choose a brow shade?',
        a: ['<ul><li>Black or dark brown hair — choose one shade <em>lighter</em> than your hair. Matching exactly looks drawn on.</li><li>Lighter or coloured hair — match your hair as closely as you can.</li><li>Grey brown is the most-chosen shade among atelierR clients, and the most forgiving.</li></ul>'] },
